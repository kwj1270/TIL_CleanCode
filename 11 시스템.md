...
# 자바에서 사용하는 관점 메커니즘
자바에서 사용하는 관점 혹은 관점과 유사한 메커니즘 3개를 살펴볼 것이다.          
...
8~90%의 경우에는 `Spring AOP`와 `JBoss AOP`로도 충분하지만,      
...
# 의사결정을 최적화하라    
모듈을 나누고 관심사를 분리하면 [지엽적인](https://ko.wiktionary.org/wiki/%EC%A7%80%EC%97%BD%EC%A0%81) 관리와 결정이 가능해진다.          
...
건축 현장을 바라보면 경탄이 나온다.      
심지어 한 겨울에도 새로운 건물이 들어서는 속도는 놀랍기 그지없다.     
오늘날 기술 발전으로 놀라운 설계도 가능하다.       
건축은 성숙한 산업이다.      
여러 세기 동안 압박 하에 발전한 최적화된 부품과 방법과 표준이 있다.       
...
애자일 기법이 팀과 프로젝트 이해관계자 사이에 의사소통 간극을 주여주듯이 말이다.   
